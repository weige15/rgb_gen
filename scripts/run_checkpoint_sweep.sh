...
CHECKPOINT_DIR="${CHECKPOINT_DIR:-runs/train_xl_attention_film_100k_b32/checkpoints}"
GENERATE_CSV="${GENERATE_CSV:-dataset/generate.csv}"
OUTPUT_PREFIX="${OUTPUT_PREFIX:-generated_images_xl_full}"
RUN_PREFIX="${RUN_PREFIX:-runs/generate_xl_full}"
SEED="${SEED:-1234}"
LIMIT="${LIMIT:-0}"
...
GUIDANCE_SCALES="${GUIDANCE_SCALES:-1.0}"
